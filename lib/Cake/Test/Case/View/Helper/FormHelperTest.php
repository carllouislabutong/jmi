 ...
 */
	public function testFormValidationAssociated() {
		...
		$result = $this->Form->create('UserForm', array('type' => 'post', 'style' => 'background-color: #224;padding: 30px; border-radius: 10px; color: white; padding: 40px;',
		'class' => 'container', 'url' => array('action' => 'login')));
		$encoding = strtolower(Configure::read('App.encoding'));
		$expected = array(
			'form' => array(
 ...
 */
	public function testFormValidationAssociatedFirstLevel() {
		...
		$result = $this->Form->create('ValidateUser', array('type' => 'post', 'style' => 'background-color: #224;padding: 30px; border-radius: 10px; color: white; padding: 40px;',
		'class' => 'container', 'url' => array('action' => 'add')));
		$encoding = strtolower(Configure::read('App.encoding'));
		$expected = array(
 ...
 */
	public function testCreateCustomRoute() {
		...
		$result = $this->Form->create('User', array('url' => array('action' => 'login'), 'style' => 'background-color: #224;padding: 30px; border-radius: 10px; color: white; padding: 40px;',
		'class' => 'container'));
		$expected = array(
			'form' => array(
 ...
 */
	public function testGetFormCreate() {
		$encoding = strtolower(Configure::read('App.encoding'));
		$result = $this->Form->create('Contact', array('type' => 'get', 'style' => 'background-color: #224;padding: 30px; border-radius: 10px; color: white; padding: 40px;',
		'class' => 'container'));
 ...
 */
	public function testDateTimeWithGetForms() {
		extract($this->dateRegex);
		$this->Form->create('Contact', array('style' => 'background-color: #224;padding: 30px; border-radius: 10px; color: white; padding: 40px;', 'class' => 'container', 'type' => 'get'));
